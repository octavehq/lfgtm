  ...
  <main class="prep-container">
    ...
    <header class="bp-section">
      ...
      <p class="text-secondary">
        ...
        <a href="[linkedin]">[Name]</a> ([Role]) ·
        <a href="[company-website]">[company.com]</a>
      </p>
    </header>
    ...
    <details class="bp-section" open id="why-company">
      ...
      <div class="news-item">
        ...
        <div class="meta">[Date] · <a href="[source]">[source]</a></div>
      ...
      <div class="grid-2">
        <div class="card reference-card">[Company like them] — [outcome]</div>
      </div>
    </details>
    ...
    <details class="bp-section" open id="stakeholders">
      ...
      <div class="grid-2">
        <div class="card stakeholder-card">
          ...
          <div>
            <div><strong><a href="[verified-linkedin]">[Name]</a></strong> — [Title]
