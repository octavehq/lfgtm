...
echo "→ cleaning $OUT"
rm -rf "$OUT"
mkdir -p "$OUT/.cursor-plugin" "$OUT/skills" "$OUT/agents"
...
jq '{
  name, version,
  description: "Octave GTM knowledge base integration for Cursor — grounded access to personas, Motions, messaging, and positioning as skills and agents.",
