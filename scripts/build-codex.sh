...
# Agent instructions are packaged as portable resources below.
...
python3 "$SRC_ROOT/scripts/package_resources.py" --source "$SRC_ROOT" --output "$OUT" --prefix "$NAMESPACE_PREFIX"
