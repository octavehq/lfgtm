...
- `get_entity_schema` - Writable fields of an entity type (key, type, required, where it is stored) plus the workspace's additional properties — call before a verbatim write to map the user's copy onto the right keys
